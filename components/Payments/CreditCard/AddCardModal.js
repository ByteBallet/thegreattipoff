...
import { MyFormHelperText2, MyFormHelperText } from '@Components/common/MyFormHelperText';
        ...
        >
            ...
            >
                <CardContent>
                    ...
                    {
                        errors.nameoncard &&
                        <MyFormHelperText>{errors.nameoncard}</MyFormHelperText>
                    }
                    ...
                    {
                        errors.cardnumber &&
                        <MyFormHelperText>{errors.cardnumber}</MyFormHelperText>
                    }
                    ...
                    <Grid container spacing={2}>
                        <Grid item xs={8}>
                            <FormControlLabel
                                ...
                                control={
                                    <FormGroup
                                        sx={{ width: 1, display: 'flex', flexDirection: 'row', flexWrap: 'nowrap', justifyContent: 'space-between' }}
                                        mx={0}
                                        px={0}
                                    >
                                        <CustomSelect
                        ...
                        <Grid item xs={12}>
                            {errors.date ?
                                ...
                                errors.ccv ?
                                    <MyFormHelperText>{errors.ccv}</MyFormHelperText> : void 0
                            }
                        </Grid>
                    </Grid>
                    <DepositAmountPanel
...
const VALIDATE = (
    ...
    if (!data.nameoncard) {
        ...
        // console.log('validate  nameoncard = ', regEx1.test(data.nameoncard), data.nameoncard);
