...
import { handleDateSliderChangeProgrammatically } from '@Components/utils/util';
import JockeyChallenge from '@Components/JockeyChallenge/JockeyChallenge';
...
const RacingDesktopHome = ({ tabs, date, activeSubMenu, handleSubMenuChange, raceType }) => {
    ...
    tabs.map((tab, idx) => {
        if (tab.MENULABEL.toLowerCase().indexOf("jump") == -1) {
    ...
    let race_settings = {
        ...
        activeTab: racingtabs[active_tab] ? active_tab : active_tab,
        hotbet: true,
    };
    ...
    const getRacingTabs = () => {
        return <Grid container spacing={0} sx={{ bgcolor: "white.main.default" }} alignItems="center" justifyContent="space-between">
            <Grid container item xs={isGTO ? 7 : 8} sx={{ bgcolor: "white.main" }} py={1} flexWrap="nowrap">
                <CustomTabs
                    tabs={racingtabs}
            ...
            <Grid item xs={isGTO ? 5 : 4} sx={{ bgcolor: "white.main", height: "100%" }}>
                                        ...
                                        <FormControlLabel
                                            ...
                                            control={
                                                <Checkbox
                                                    sx={{
                                                        padding: '4px 12px',
                                                        bgcolor: raceObj[key].value ? "primary.main" : "grey.primary",
                                                        borderRadius: 10
                                                    }}
                                        ...
                                        <FormControlLabel
                                            ...
                                            control={
                                                <Checkbox
                                                    sx={{
                                                        padding: '4px 12px',
                                                        bgcolor: hotbetObj.value ? "white.main" : "grey.primary",
                                                        borderRadius: 10,
                                                        border: hotbetObj.value ? 1 : 0,
                                                    ...
                                                    checkedIcon={
                                                        <SvgIcon
                                                            ...
                                                            sx={{
                                                                fontSize: 18, color: "info.comment"
                                                            }}
                                                        />
                                                    }
                                                />
                                                ...
                                                <FormControlLabel
                                                    ...
                                                    control={
                                                        <Checkbox
                                                            sx={{
                                                                padding: '4px 12px',
                                                                bgcolor: CountryObj[key].value ? "primary.main" : "grey.primary",
                                                                borderRadius: 10
                                                            }}
...
export default RacingDesktopHome;
